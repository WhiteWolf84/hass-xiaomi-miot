...
TRANSLATION_LANGUAGES = {
    'it': {
        ...
        '_globals': {
            'mode': 'Modalità',
            'switch status': 'Interruttore',
            'battery level': 'Livello batteria',
            'target temperature': 'Temperatura desiderata',
            'temperature': 'Temperatura',
            'relative humidity': 'Umidità relativa',
            'illumination': 'Illuminazione',
            'indicator light': 'Spia luminosa',
            'physical control locked': 'Blocco comandi fisici',
            'device fault': 'Guasto dispositivo',
            'no faults': 'Nessun guasto',
            'fault': 'Guasto',
            'status': 'Stato',
            'delay remain time': 'Tempo rimanente',
            'left time': 'Tempo rimanente',
            'target humidity': 'Umidità desiderata',
            'water level': 'Livello acqua',
            'alarm': 'Allarme',
            'countdown': 'Conto alla rovescia',
            'power consumption': 'Consumo energetico',
            'device fault': 'Guasto dispositivo',
            'water shortage status': 'Mancanza acqua',
            'horizontal swing': 'Oscillazione orizzontale',
            'vertical swing': 'Oscillazione verticale',
            'fan level': 'Livello ventola',
            'air quality': 'Qualità aria',
            'charging state': 'Stato di ricarica',
        ...
        'air_conditioner': {
            'air conditioner': 'Climatizzatore',
        },
        ...
        'airer': {
            'airer': 'Stendibiancheria',
            'dryer': 'Asciugatura',
            'drying_level': 'Livello di asciugatura',
            'left_time': 'Tempo rimanente',
            'fault': 'Guasto',
        },
        'airer.dryer': {
            'Hot Air Drying': 'Asciugatura ad aria calda',
            'Air Drying': "Asciugatura all'aria",
        },
        'airer.fault': {
            'No Faults': 'Nessun guasto',
            ...
            'Motor Failure': 'Guasto al motore',
        },

        'battery': {
            'battery battery level': 'Livello batteria',
            'battery charging state': 'Stato di ricarica',
        },

        'dishwasher': {
            'dishwasher status': 'Stato',
            'dishwasher switch status': 'Interruttore',
            'dishwasher mode': 'Modalità',
            'dishwasher left time': 'Tempo rimanente',
            'start wash': 'Avvia lavaggio',
            'Start Wash': 'Avvia lavaggio',
            'stop washing': 'Ferma lavaggio',
            'Stop Washing': 'Ferma lavaggio',
        },
        'dishwasher.mode': {
            'basic': 'Base',
            ...
            'Energy Saving': 'Risparmio energetico',
            'quick wash': 'Lavaggio rapido',
            'Quick Wash': 'Lavaggio rapido',
            'glass': 'Cristalli',
            'Glass': 'Cristalli',
            'disinfecting': 'Disinfezione',
            'Disinfecting': 'Disinfezione',
        },
        'dishwasher.status': {
            'off': 'Spento',
        ...
        'door_state': {
            'open': 'Aperta',
            'close': 'Chiusa',
            'close_timeout': 'Chiusura non riuscita',
            'knock': 'Bussato',
            'breaking': 'Effrazione',
            'stuck': 'Bloccata',
        },
        ...
        'environment': {
            ...
            'environment relative humidity': 'Umidità ambiente',
            'environment air quality': 'Qualità aria',
            'environment pm2.5 density': 'PM2.5',
            'environment co2 density': 'CO₂',
            'environment tvoc density': 'TVOC',
        },

        'fan.mode': {
            'basic': 'Base',
            'basic wind': 'Vento standard',
            'straight wind': 'Vento diretto',
            'natural wind': 'Vento naturale',
            'circular wind': 'Vento circolare',
            'energy saving': 'Risparmio energetico',
            'none': 'Nessuna',
            'baby': 'Bambino',
            'smart': 'Intelligente',
        ...
        'filter': {
            'filter left time': 'Durata filtro rimanente',
            'filter used time': 'Ore di utilizzo filtro',
            'filter life level': 'Vita residua filtro',
        },

        'intelligent_speaker': {
            'wake up': 'Attiva assistente',
            'play radio': 'Riproduci radio',
            'play text': 'Pronuncia testo',
            'execute text directive': 'Esegui comando vocale',
            'play music': 'Riproduci musica',
        },

        'ir_aircondition_control': {
            'ir aircondition control': 'Telecomando climatizzatore',
            'mode for ir': 'Modalità',
            'temperature for ir': 'Temperatura',
            'turn on': 'Accendi',
            'turn off': 'Spegni',
            'fan speed down': 'Riduci velocità ventola',
            'fan speed up': 'Aumenta velocità ventola',
            'temperature down': 'Abbassa temperatura',
            'temperature up': 'Alza temperatura',
        },
        ...
        'lock_action': {
            'outside_unlock': "Sbloccata dall'esterno",
            'lock': 'Bloccata',
            'anti_lock_on': 'Antiapertura attivata',
            'anti_lock_off': 'Antiapertura disattivata',
            'inside_unlock': "Sbloccata dall'interno",
            'lock_inside': "Bloccata dall'interno",
            'lock_outside': "Bloccata dall'esterno",
            'child_lock_on': 'Blocco bambini attivato',
            'child_lock_off': 'Blocco bambini disattivato',
        },

        'magnet_sensor': {
            'magnet sensor': 'Sensore porta/finestra',
            'magnet sensor illumination': 'Illuminazione',
        },
        'motion_sensor': {
            'motion sensor': 'Sensore di movimento',
            'motion sensor illumination': 'Illuminazione',
        },
        'occupancy_sensor': {
            'occupancy sensor occupancy status': 'Presenza',
        },
        'occupancy_sensor.occupancy_status': {
            'someone exists': 'Presenza rilevata',
            'no one exists': 'Nessuna presenza',
        },
        ...
        'play_control': {
            'play control': 'Riproduzione',
            'keycodes': 'Codici tasto',
        },

        'power_consumption': {
            'power consumption': 'Consumo energetico',
            'power consumption electric power': 'Potenza',
            'power consumption electric current': 'Corrente',
            'power consumption electric voltage': 'Tensione',
            'power consumption voltage': 'Tensione',
        },

        'ptc_bath_heater': {
            'ptc bath heater': 'Termoventilatore da bagno',
        },
        'ptc_bath_heater.mode': {
            'fan': 'Ventilazione',
            'heat': 'Riscaldamento',
            'ventilate': 'Ricambio aria',
            'dry': 'Deumidificazione',
            'defog': 'Antiappannamento',
            'quick heat': 'Riscaldamento rapido',
            'quick defog': 'Antiappannamento rapido',
        },
        ...
        'television': {
            'input control': 'Sorgente',
            'tv input control': 'Sorgente TV',
        },

        'temperature_humidity_sensor': {
            'temperature humidity sensor temperature': 'Temperatura',
            'temperature humidity sensor relative humidity': 'Umidità relativa',
            'temperature humidity sensor atmospheric pressure': 'Pressione atmosferica',
        },

        'vacuum': {
            'robot cleaner': 'Robot aspirapolvere',
            'robot cleaner status': 'Stato',
        },
        'vacuum.mode': {
            'basic': 'Base',
            'silent': 'Silenzioso',
            ...
            'strong': 'Intenso',
            'turbo': 'Turbo',
            'full speed': 'Massima potenza',
        },
        'vacuum.sweep_mop_type': {
            'sweep': 'Aspirazione',
            'mop': 'Lavaggio',
            'sweep mop': 'Aspirazione e lavaggio',
            'sweep before mopping': 'Aspira prima di lavare',
        },
        'sweep.suction_state': {
            'silent': 'Silenzioso',
            'slient': 'Silenzioso',
        ...
        'washer': {
            ...
            'high water switch': 'Livello acqua alto',
            'rinsh times': 'Numero di risciacqui',
            'shake time': 'Centrifuga',
            'sleep mode': 'Modalità notte',
            'soak time': 'Ammollo',
            'spin speed': 'Velocità centrifuga',
            'start wash': 'Avvia lavaggio',
            'steam sterilization': 'Sterilizzazione a vapore',
            'target temperature': 'Temperatura desiderata',
            'target water level': 'Livello acqua desiderato',
        },
        'washer.drying_level': {
            'none': 'Nessuno',
        ...
        'washer.mode': {
            ...
            'delicate wash': 'Delicati',
            'daily wash': 'Quotidiano',
            'heavy wash': 'Capi molto sporchi',
            'quick wash': 'Rapido',
            'super quick': 'Super rapido',
            'intensive': 'Intensivo',
            'boiling': 'Alta temperatura',
            'rinse': 'Risciacquo',
            'rinse spin': 'Risciacquo e centrifuga',
            'spin': 'Centrifuga',
            'dry': 'Asciugatura',
            'dry timing': 'Asciugatura a tempo',
            'dry air wash': 'Lavaggio ad aria',
            'wash dry': 'Lava e asciuga',
            'quick wash dry': 'Lava e asciuga rapido',
            'pleased wash dry': 'Lava e asciuga delicato',
            'drum clean': 'Pulizia cestello',
            'drum dry': 'Asciugatura cestello',
            'mite removal': 'Antiacaro',
            'bacteria mite removal': 'Antibatterico e antiacaro',
            'color protection': 'Protezione colore',
            'baby care': 'Capi neonato',
            'new clothes wash': 'Capi nuovi',
            'aromatherapy wash': 'Lavaggio profumato',
            'soak wash': 'Ammollo',
            'gold wash': 'Lavaggio premium',
            'mix': 'Misti',
            'smart': 'Intelligente',
            'user define': 'Personalizzato',
        },
        ...
        'dehumidifier': {
            ...
            'dehumidifier device fault': 'Guasto dispositivo',
            'dehumidifier fault': 'Guasto',
            'dehumidifier mode': 'Modalità',
            'dehumidifier status': 'Stato',
            'dehumidifier target humidity': 'Umidità desiderata',
        },
        'humidifier': {
            'humidifier': 'Umidificatore',
            'humidifier device fault': 'Guasto dispositivo',
            'humidifier fault': 'Guasto',
            'humidifier mode': 'Modalità',
            'humidifier status': 'Stato',
            'humidifier target humidity': 'Umidità desiderata',
            'humidifier water level': 'Livello acqua',
        },
        'delay': {
            'delay': 'Ritardo',
            'delay delay remain time': 'Tempo rimanente',
            'delay remain time': 'Tempo rimanente',
        },
        'no_disturb': {
            'no disturb': 'Non disturbare',
            'no disturb no disturb': 'Non disturbare',
        },
        'physical_controls_locked': {
            'physical controls locked': 'Blocco comandi fisici',
            'physical controls locked physical controls locked': 'Blocco comandi fisici',
        },
        'pet_drinking_fountain': {
            'pet drinking fountain': 'Fontanella per animali',
            'pet drinking fountain mode': 'Modalità erogazione',
            'pet drinking fountain fault': 'Guasto',
            'pet drinking fountain water shortage status': 'Mancanza acqua',
            'pet drinking fountain out water interval': 'Intervallo di erogazione',
        },
        'fan_control': {
            'fan control': 'Controllo ventola',
            'fan control fan level': 'Livello ventola',
            'fan control horizontal swing': 'Oscillazione orizzontale',
            'fan control vertical swing': 'Oscillazione verticale',
        },
        'custom': {
            'clean area': 'Area pulita',
            'clean time': 'Tempo di pulizia',
            'props clean area': 'Area pulita',
            'props clean time': 'Tempo di pulizia',
            'power cost today': 'Consumo di oggi',
            'power cost month': 'Consumo del mese',
            'prop cal day power cost today': 'Consumo di oggi',
            'prop cal day power cost month': 'Consumo del mese',
            'lock action': 'Azione serratura',
            'door state': 'Stato porta',
    ...
    'uk': {
        ...
        'pause': 'Пауза',
        'fault': 'Несправний',
        'Charge-Full': 'Заряджений',

        '_globals': {
            'mode': 'Режим',
            'switch status': 'Статус перемикача',
            ...
            'indicator light': 'Світловий індикатор',
            'physical control locked': 'Фізичний контроль заблоковано',
        },
        ...
        'battery': {
            'battery battery level': 'рівень заряду батареї',
            'battery charging state': 'стан заряджання акумулятора',
        },

        'door_state': {
            'open': 'відкрита',
            'close': 'закрита',
            'close_timeout': 'тайм-аут_закриття',
            'knock': 'стукіт',
            'breaking': 'порушення',
            'stuck': 'застряглий',
        },
        ...
        'fan.mode': {
            'basic': 'базовий',
            'basic wind': 'базова швидкість вентилятора',
            'straight wind': 'рівна швидкість вентилятора',
            'natural wind': 'природна швидкість вентилятора',
            'energy saving': 'збереження енергії',
            'none': 'ніякий',
            'baby': 'дитина',
            'smart': 'розумний',
            'sleep': 'сплячий',
            'strong': 'сильний',
            'circular wind': 'кругова швидкість вентилятора',
        },

        'ir_aircondition_control': {
            'ir aircondition control': 'управління кондиціонером',
            'mode for ir': 'режим',
            'temperature for ir': 'температура',
            'turn on': 'включити',
            'turn off': 'вимкнути',
            'fan speed down': 'зменшити швидкість вентилятора-',
            'fan speed up': 'збільшити швидкість вентилятора+',
            'temperature down': 'зменшити температуру-',
            'temperature up': 'збільшити температуру+',
        },
        'ir_aircondition_control.ir_mode': {
            'auto': 'авто',
            'cool': 'охолодження',
        ...
        'magnet_sensor': {
            'magnet sensor': 'магнітний датчик',
        },

        'motion_sensor': {
            'motion sensor': 'датчик руху',
            'motion sensor illumination': 'підсвічування датчика руху',
        },
        ...
        'play_control': {
            ...
            'keycodes': 'коди клавіш',
        },

        'power_consumption': {
            'power consumption': 'споживана потужність',
            'power consumption electric power': 'споживана електрична потужність',
            'power consumption electric current': 'споживаний електричний струм',
            'power consumption electric voltage': 'споживана електрична напруга',
        },

        'ptc_bath_heater': {
            'ptc bath heater': 'нагрівач для ванни',
        },
        'ptc_bath_heater.mode': {
            'fan': 'вентилятор',
            'heat': 'опалення',
            ...
            'dry': 'осушення',
            'defog': 'усунення запотівання',
            'quick heat': 'швидке нагрівання',
            'quick defog': 'швидке усунення запотівання',
        },
        ...
        'television': {
            'input control': 'керування входом',
            'tv input control': 'керування входом телевізора',
        },

        'temperature_humidity_sensor': {
            'temperature humidity sensor temperature': 'температура датчика вологості',
            'temperature humidity sensor relative humidity': 'відносна вологість датчика температури',
            'temperature humidity sensor atmospheric pressure': 'атмосферний тиск датчика температури вологості',
        },

        'vacuum': {
            'robot cleaner': 'робот-пилосос',
            'robot cleaner status': 'статус робота-пилососа',
            'robot cleaner mode': 'режим прибирання',
            'robot cleaner sweep type': 'тип прибирання',
        },
        'alarm': {
            'alarm': 'Подати сигнал',
            'alarm volume': 'Гучність',
        },
        'vacuum.status': {
            'sleep': 'Сон',
            'idle': 'Чекання',
            'paused': 'На паузі',
            'go charging': 'Їде на зарядку',
            'charging': 'Заряджається',
            'sweeping': 'Сухе прибирання',
            'sweeping and mopping': 'Сухе та вологе прибирання',
            'mopping': 'Вологе прибирання',
            'upgrading': 'Оновлення',
        },
        'vacuum.mode': {
            'basic': 'базовий',
            ...
            'strong': 'сильний',
            'turbo': 'турбо',
            'full speed': 'максимальна швидкість',
            'sweep': 'Суха',
            'sweep and mop': 'Суха та волога',
            'mop': 'Волога',
        },
        'vacuum.sweep_type': {
            'Global': 'Глобальна',
        ...
        'sweep': {
            ...
            'sweep main-brush-life': 'ресурс основної щітки',
            'sweep side-brush-life': 'ресурс бічної щітки',
            'sweep repeat-state': 'подвійне прибирання',
            'sweep water_state': 'змочування ганчірки',
            'sweep cleaning_area': 'площа збирання',
            'sweep cleaning_time': 'час прибирання',
            'sweep pet-recognize': 'розпізнавання тварин',
            'sweep mop-route': 'тип вологого прибирання',
            'sweep ai_recognize': 'розпізнавання AI',
        ...
        'washer': {
            'drying level': 'рівень сушіння',
            'rinsh times': 'час полоскання',
            'spin speed': 'швидкість віджиму',
            'target water level': 'цільовий рівень води',
        },
        'washer.mode': {
            ...
            'delicate wash': 'делікатне прання',
            'down coat': 'пуховик',
            'drum clean': 'очищення барабана',
            'drum dry': 'сушіння в барабані',
            'dry air wash': 'сушіння повітрям',
            'dry timing': 'час сушіння',
            'dry': 'сушити',
            'gold wash': 'золоте прання',
            'heavy wash': 'велике прання',
            'intensive': 'інтенсивний',
            'jacket': 'куртка',
            'jeans': 'джинси',
            'mite removal': 'видалення кліща',
            'quick wash dry': 'швидке сухе прання',
            'quick wash': 'швидке прання',
            'rinse spin': 'режим полоскання',
            'rinse': 'полоскати',
            'shirt': 'сорочка',
            'silk': 'шовк',
            'soak wash': 'замочити',
    ...
    'tr': {
        ...
        'vacuum.sweep_mop_type': {
            'sweep': 'Süpürme',
            'mop': 'Paspas',
            'sweep mop': 'Süpür ve Paspasla',
            'sweep before mopping': 'Önce Süpür Sonra Paspasla',
        },

        'washer': {
            'drying level': 'Kurutma Seviyesi',
            'drying time': 'Kurutma Süresi',
            'high water switch': 'Yüksek Su Seviyesi',
            'rinsh times': 'Durulama Sayısı',
            'shake time': 'Çalkalama Süresi',
            'sleep mode': 'Gece Modu',
            'soak time': 'Bekletme Süresi',
            'spin speed': 'Sıkma Hızı',
            'start wash': 'Yıkamaya Başla',
            'status': 'Çalışma Durumu',
            'steam sterilization': 'Buhar Sterilizasyonu',
            'target temperature': 'Yıkama Sıcaklığı',
            'target water level': 'Su Seviyesi',
        },
        'washer.mode': {
            'aromatherapy wash': 'Aromaterapi Yıkama',
            'baby care': 'Bebek Bakımı',
            'bacteria mite removal': 'Bakteri ve Akar Temizleme',
            'boiling': 'Haşlama',
            ...
            'mix': 'Karışık Yıkama',
            'new clothes wash': 'Yeni Giysiler',
            'pleased wash dry': 'Keyifli Yıkama ve Kurutma',
        ...
        'washer.drying_level': {
            ...
            'none': 'Kurutmasız',
            'normal': 'Normal',
            'smart': 'Akıllı Kurutma',
            'timed': 'Zamanlı Kurutma',
        },

        'dishwasher': {
            'dishwasher left time': 'Kalan Yıkama Süresi',
            'dishwasher mode': 'Yıkama Modu',
            'dishwasher status': 'Durum',
            'dishwasher switch status': 'Anahtar',
            'start wash': 'Yıkamaya Başla',
            'stop washing': 'Yıkamayı Durdur',
        },
        'dishwasher.mode': {
            'basic': 'Standart Yıkama',
            'disinfecting': 'Dezenfekte Yıkama',
            'energy saving': 'Enerji Tasarruflu Yıkama',
            'glass': 'Cam Yıkama',
            'intensive': 'Yoğun Yıkama',
            'quick wash': 'Hızlı Yıkama',
        },
        'dishwasher.status': {
            'busy': 'Çalışıyor',
            'completed': 'Yıkama Tamamlandı',
            'delay': 'Zamanlandı',
            'idle': 'Durduruldu',
            'off': 'Kapalı',
            'paused': 'Duraklatıldı',
